...
export default function HealthcareList() {
	...
	const CreateAmbulance = useFormik({
		...
		onSubmit: (values) => {
			...
			const createAmbulance = async () => {
				console.log(JSON)
				try {
					await axios.post(`${Vars.domain}/facilities`, JSON, config).then((res) => {
						console.log(res)
	...
	const EditAmbulance = useFormik({
		...
		onSubmit: (values) => {
			...
			const editAmbulance = async () => {
				console.log(JSON)
				try {
					await axios.patch(`${Vars.domain}/facilities/${selectedAmbulance?.id}`, JSON, config).then((res) => {
						console.log(res)
	...
	const AmbulanceDelete = useFormik({
		...
		onSubmit: async () => {
			try {
				const result = await axios.delete(`${Vars.domain}/facilities/${isDeleteID}`, config)

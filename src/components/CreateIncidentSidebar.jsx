...
const CreateIncidentSidebar = ({ onClose, data, selectmap }) => {
	...
	const renderFormForTab = () => {
		switch (activeTab) {
			case 'Incident':
				return <Header getlatitude={data} handleIncidentNext={handleIncidentNext} />
			case 'Ambulance':
				return (
					<AmbulanceForm
		...
		<>
			...
			<form onSubmit={createIncident.handleSubmit}>
				<div className="mb-5 mt-2">
					<div>
						<label htmlFor="informer_address" className=" text-sm  font-medium leading-6 text-gray-900 text-right">
							<button
								type="button"
				...
				<div className="mb-5 mt-2">
					<div>
						<label htmlFor="informer_name" className="block text-sm font-medium leading-6 text-gray-900 text-right">
							Name
						</label>
						<div className="relative mt-2">
							<input
				...
				<div className="mb-5">
					<div>
						<label htmlFor="description" className="block text-sm font-medium leading-6 text-gray-900 text-right">
							Description
						</label>
						<div className="mt-2">
							<textarea

				...
				<div className="bg-lightGray-100 ml-16 rounded-lg     mt-2">
					...
					<div className="flex justify-end ">
						<Tab
							...
							className={`${activeTab === 'incidentTypeMapping' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'}`}
						/>{' '}
						<Tab
							selected={activeTab === 'departmentMapping'}
							title="ربط الأقسام بالحوادث "
							onClick={() => handleTabChange('departmentMapping')}
							className={`${activeTab === 'departmentMapping' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'}`}
						/>
					</div>
											...
											<table className="w-full">
												<thead>
													<tr className="border-b border-gray-300 m-6">
														<th className="text-gray-800 text-right mb-4">انواع الحوادث </th>
														<th className="text-gray-800 text-right mb-4">الاقسام</th>
													</tr>
												</thead>
												<tbody>
											...
											<table className="w-full">
												<thead>
													<tr className="border-b border-gray-300">
														<th className="text-gray-800 text-right">المعدات </th>
														<th className="text-gray-800 text-right">نوع الحادث </th>
													</tr>
												</thead>
												<tbody>
													{incident.map((item) => (

		...
		return (
			<button
				className={`px-4 py-2 transition-colors duration-150 ${
					selected ? 'bg-blue-500 text-white' : 'bg-white  hover:bg-gray-200  text-black'
				} focus:outline-none`}
				onClick={onClick}
				style={{
		...
		>
			...
			<div className="bg-lightGray-100 ml-20 rounded-t-lg     mt-2 ">
				<div className="p-4 text-center  ">
					<h1 className="text-2xl font-semibold m-2 mt-3 justify-center"> البحث</h1>
				</div>{' '}
				<div className="flex justify-end ">
					<Tab
						...
						className={`${
							activeTab === 'vehicleModel' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500 hover:bg-gray-200'
						}`}
					/>{' '}
					<Tab
						...
						className={`${
							activeTab === 'vehicleMake' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500 hover:bg-gray-200'
						}`}
					/>{' '}
					<Tab
						...
						title="الاقسام"
						className={`${activeTab === 'Departments' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'}`}
					/>
					<Tab
						selected={activeTab === 'incidentType'}
						onClick={() => handleTabClick('incidentType')}
						title="نوع الحادث"
						className={`${activeTab === 'incidentType' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'}`}
					/>
					<Tab
						selected={activeTab === 'gender'}
						onClick={() => handleTabClick('gender')}
						title="الجنس"
						className={`${activeTab === 'gender' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'}`}
					/>{' '}
					<Tab
						selected={activeTab === 'emergencyType'}
						title="نوع الحالة"
						onClick={() => handleTabClick('emergencyType')}
						className={`${activeTab === 'emergencyType' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'}`}
					/>{' '}
					<Tab
						selected={activeTab === 'reasons'}
						title="اسباب الرفض"
						onClick={() => handleTabClick('reasons')}
						className={`${activeTab === 'reasons' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'}`}
					/>
					<Tab
						...
						className={`${
							activeTab === 'equipments' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500 hover:bg-gray-200'
						}`}
					/>{' '}
				</div>
			</div>

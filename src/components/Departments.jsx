    ...
    onSubmit: (values) => {
      ...
      const UpdateEquipment = async () => {
        ...
        try {
          await axios
            .patch(
              `${Vars.domain}/departments/${editingDepartment?.id}`,
              JSON,
              config
            )
            .then((res) => {
                        ...
                        <div>
                          ...
                          <div className="relative mt-2">
                            <input
                              ...
                              value={
                                CreateDepartments.values.occupied_beds_women
                              }
                        ...
                        <div>
                          ...
                          <div className="relative mt-2">
                            <input
                              ...
                              onChange={CreateDepartments.handleChange}
                              value={
                                CreateDepartments.values.unoccupied_beds_men
                              }
                        ...
                        <div>
                          ...
                          <div className="relative mt-2">
                            <input
                              ...
                              onChange={CreateDepartments.handleChange}
                              value={
                                CreateDepartments.values.unoccupied_beds_women
                              }

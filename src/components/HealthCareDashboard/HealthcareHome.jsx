								...
								<tbody>
									{incident?.data?.map((item) => (
										<tr className="hover:bg-gray-100">
											...
											<td className="whitespace-nowrap px-3 py-4 text-md">{item.informer_address}</td>
											<td className="whitespace-nowrap px-3 py-4 text-md">{item.type}</td>

											<td className="whitespace-nowrap px-3 py-4 text-md">{item.description}</td>
											<td className="whitespace-nowrap px-3 py-4 text-md">{item.incident_type_id}</td>
											<td className="whitespace-nowrap px-3 py-4 text-md">{item.informer_name}</td>
										</tr>
									))}
								</tbody>
							</table>

    ...
    onSubmit: (values) => {
      ...
      const UpdateEquipment = async () => {
        ...
        try {
          await axios
            .patch(
              `https://ars.disruptwave.com/api/departments/${editingDepartment?.id}`,
              JSON,
              config
            )
            .then((res) => {
            ...
            >
              ...
              <dl className="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6 bg-white">
                <div className="flex justify-between gap-x-4 py-3">
                  <dd className="">{item.total_beds}</dd>
                ...
                <div className="flex justify-between gap-x-4 py-3">
                  <dd className="flex items-start gap-x-2">
                    <div className="flex gap-x-1 divide-x bg-pink-200 px-2 divide-pink-400 text-pink-600 rounded-lg">
                      <span>Women</span>
                      <span className="pl-1">{item.occupied_beds_women}</span>
                    </div>
                    <div className="flex gap-x-1 divide-x bg-blue-200 px-2 divide-blue-400 text-blue-600 rounded-lg">
                      <span>Men</span>
                      <span className="pl-1">{item.occupied_beds_men}</span>
                    </div>
                  </dd>
                ...
                <div className="flex justify-between gap-x-4 py-3">
                  <dd className="flex items-start gap-x-2">
                    <div className="flex gap-x-1 divide-x bg-pink-200 px-2 divide-pink-400 text-pink-600 rounded-lg">
                      <span>Women</span>
                      <span className="pl-1">{item.unoccupied_beds_women}</span>
                    </div>
                    <div className="flex gap-x-1 divide-x bg-blue-200 px-2 divide-blue-400 text-blue-600 rounded-lg">
                      <span>Men</span>
                      <span className="pl-1">{item.unoccupied_beds_men}</span>
                    </div>
                  </dd>

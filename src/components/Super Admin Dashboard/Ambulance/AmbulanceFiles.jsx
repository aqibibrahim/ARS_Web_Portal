...
const AmbulanceFiles = () => {
	...
	const handleEditClick = (ambulance) => {
		...
		setSelectedModelOption({ label: ambulance?.model?.name, value: ambulance?.model?.id })
	...
	const EditAmbulance = useFormik({
		...
		onSubmit: (values) => {
			const JSON = {
				...
				gps_longitude: locationAddress?.gps_latitude,
				parking_latitude: locationAddress?.latitude,
				parking_longitude: locationAddress?.longitude,
											...
											<input
												...
												value={
													locationAddress?.address
														? locationAddress?.address
														: ['latitude ' + locationAddress?.latitude + ' longitude ' + locationAddress?.longitude]
												}
												type="text"
												name="addresss"
												id="addresss"
